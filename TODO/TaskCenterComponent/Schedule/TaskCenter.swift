...
open class TaskCenter {
    ...
    open func remove(_ task: STTask) {
    ...
    open func addTag(_ tag: String, to task: STTask) {
        addTags([tag], to: task)
    }
    ...
    ///
    /// If the task is not in this center, do nothing.
    open func addTags(_ tags: [String], to task: STTask) {
    ...
    ///
    /// If the task is not in this center, do nothing.
    open func removeTag(_ tag: String, from task: STTask) {
    ...
    ///
    /// If the task is not in this center, do nothing.
    open func removeTags(_ tags: [String], from task: STTask) {
        guard task.taskCenter === self else { return }
    ...
    open func tags(forTask task: STTask) -> [String] {
        guard task.taskCenter === self else { return [] }
    ...
    open func tasks(forTag tag: String) -> [STTask] {
        return lock.withLock {
