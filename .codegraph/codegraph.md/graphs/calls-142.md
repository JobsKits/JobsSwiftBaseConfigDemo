...
```mermaid
flowchart LR
  S1["method:NSAttributedString::as_attributesAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:23"]
  T1["method:ASMutableAttributedStringBuilder::attributesAtIndex:effectiveRange:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/Details/ASMutableAttributedStringBuilder.mm:229"]
  S1 -->|calls| T1
  S2["method:NSAttributedString::as_fontAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:44"]
  ...
  S2 -->|calls| T2
  S3["method:NSAttributedString::as_kernAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:52"]
  ...
  S3 -->|calls| T3
  S4["method:NSAttributedString::as_colorAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:60"]
  ...
  S5 -->|calls| T5
  S6["method:NSAttributedString::as_backgroundColorAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:80"]
  ...
  S6 -->|calls| T6
  S7["method:NSAttributedString::as_strokeWidthAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:88"]
  ...
  S7 -->|calls| T7
  S8["method:NSAttributedString::as_strokeColorAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:96"]
  ...
  S9 -->|calls| T9
  S10["method:NSAttributedString::as_shadowAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:109"]
  ...
  S10 -->|calls| T10
  S11["method:NSAttributedString::as_strikethroughStyleAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:117"]
  ...
  S11 -->|calls| T11
  S12["method:NSAttributedString::as_strikethroughColorAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:126"]
  ...
  S12 -->|calls| T12
  S13["method:NSAttributedString::as_underlineStyleAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:134"]
  ...
  S13 -->|calls| T13
  S14["method:NSAttributedString::as_underlineColorAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:143"]
  ...
  S15 -->|calls| T15
  S16["method:NSAttributedString::as_ligatureAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:156"]
  ...
  S16 -->|calls| T16
  S17["method:NSAttributedString::as_textEffectAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:164"]
  ...
  S17 -->|calls| T17
  S18["method:NSAttributedString::as_obliquenessAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:172"]
  ...
  S18 -->|calls| T18
  S19["method:NSAttributedString::as_expansionAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:180"]
  ...
  S19 -->|calls| T19
  S20["method:NSAttributedString::as_baselineOffsetAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:188"]
  ...
  S20 -->|calls| T20
  S21["method:NSAttributedString::as_verticalGlyphFormAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:196"]
  ...
  S21 -->|calls| T21
  S22["method:NSAttributedString::as_languageAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:205"]
  ...
  S22 -->|calls| T22
  S23["method:NSAttributedString::as_writingDirectionAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:213"]
  ...
  S23 -->|calls| T23
  S24["method:NSAttributedString::as_paragraphStyleAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:221"]
  ...
  S24 -->|calls| T24
  S25["method:NSAttributedString::as_textShadowAtIndex:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/TextExperiment/Utility/NSAttributedString+ASText.mm:376"]
