...
flowchart LR
  ...
  T17["method:Plan::merge<br/>TODO/TaskCenterComponent/Schedule/Plan.swift:223"]
  S17 -->|calls| T17
  ...
  T25["method:Dictionary::normalizedJSONObject<br/>JobsByPods/JobsNetworking@Pods/Request/JobsValue.swift:23"]
  S25 -->|calls| T25
```
