...
```mermaid
flowchart LR
  S1["method:ASCellNode::propertiesForDebugDescription<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:324"]
  T1["method:ASCellNode::propertiesForDebugDescription<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:324"]
  S1 -->|calls| T1
  ...
  S3 -->|calls| T3
  S4["method:ASTextCellNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:407"]
  T4["method:ASTextCellNode::initWithAttributes:insets:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:412"]
  S4 -->|calls| T4
  S5["method:ASTextCellNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:407"]
  T5["method:ASTextCellNode::defaultTextAttributes<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:429"]
  S5 -->|calls| T5
  S6["method:ASTextCellNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:407"]
  T6["method:ASTextCellNode::defaultTextInsets<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:434"]
  S6 -->|calls| T6
  S7["method:ASTextCellNode::initWithAttributes:insets:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:412"]
  T7["method:ASTextCellNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:407"]
  S7 -->|calls| T7
  ...
  S8 -->|calls| T8
  S9["method:ASTextCellNode::setTextAttributes:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:444"]
  T9["method:ASTextCellNode::locked_updateAttributedText<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:478"]
  S9 -->|calls| T9
  S10["method:ASTextCellNode::setTextInsets:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:458"]
  ...
  S10 -->|calls| T10
  S11["method:ASTextCellNode::setText:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:470"]
  T11["method:ASTextCellNode::locked_updateAttributedText<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:478"]
  S11 -->|calls| T11
  S12["method:ASTextCellNode::locked_updateAttributedText<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCellNode.mm:478"]
  ...
  S13 -->|calls| T13
  S14["file:JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCollectionNode+Beta.h<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASCollectionNode+Beta.h:1"]
