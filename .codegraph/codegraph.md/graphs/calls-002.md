...
flowchart LR
  ...
  S3 -->|calls| T3
  S4["function:Win32Window::Create<br/>my_flutter/windows/runner/win32_window.cpp:123"]
  T4["function:Scale<br/>my_flutter/windows/runner/win32_window.cpp:36"]
  S4 -->|calls| T4
  S5["function:CALLBACK Win32Window::WndProc<br/>my_flutter/windows/runner/win32_window.cpp:157"]
  T5["function:EnableFullDpiSupportIfAvailable<br/>my_flutter/windows/runner/win32_window.cpp:42"]
  S5 -->|calls| T5
  S6["function:Win32Window::Destroy<br/>my_flutter/windows/runner/win32_window.cpp:224"]
  T6["method:WindowClassRegistrar::GetInstance<br/>my_flutter/windows/runner/win32_window.cpp:64"]
  S6 -->|calls| T6
  ...
  T7["method:ASLayoutElementStyle::justifyContent<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/Layout/ASLayoutElement.mm:804"]
  S7 -->|calls| T7
  S8["function:ASButtonNodeResolveHorizontalAlignmentForStyle<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode+Yoga.mm:16"]
  ...
  S9 -->|calls| T9
  S10["function:ASButtonNodeResolveVerticalAlignmentForStyle<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode+Yoga.mm:24"]
  T10["method:ASLayoutElementStyle::justifyContent<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/Layout/ASLayoutElement.mm:804"]
  S10 -->|calls| T10
  ...
  T11["method:ASDisplayNode::_locked_style<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASDisplayNode+Layout.mm:57"]
  S11 -->|calls| T11
  ...
  T12["method:ASLayoutElementStyle::yogaNodeCreateIfNeeded<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/Layout/ASLayoutElement.mm:778"]
  S12 -->|calls| T12
  ...
  T13["function:ASButtonNodeResolveHorizontalAlignmentForStyle<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode+Yoga.mm:16"]
  S13 -->|calls| T13
  ...
  T14["function:ASButtonNodeResolveVerticalAlignmentForStyle<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode+Yoga.mm:24"]
  S14 -->|calls| T14
  ...
  S17 -->|calls| T17
  S18["method:ASButtonNode::updateYogaLayoutIfNeeded<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode+Yoga.mm:34"]
  T18["function:ASEdgeInsetsMake<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/Layout/ASDimension.mm:114"]
  S18 -->|calls| T18
  ...
  S19 -->|calls| T19
  S20["method:ASButtonNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:32"]
  ...
  S20 -->|calls| T20
  S21["method:ASButtonNode::titleNode<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:50"]
  T21["method:ASButtonNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:32"]
  S21 -->|calls| T21
  S22["method:ASButtonNode::imageNode<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:70"]
  T22["method:ASButtonNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:32"]
  S22 -->|calls| T22
  S23["method:ASButtonNode::backgroundImageNode<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:80"]
  T23["method:ASButtonNode::init<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:32"]
  S23 -->|calls| T23
  S24["method:ASButtonNode::setEnabled:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:97"]
  T24["method:ASButtonNode::updateButtonContent<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:122"]
  S24 -->|calls| T24
  S25["method:ASButtonNode::setHighlighted:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASButtonNode.mm:106"]
