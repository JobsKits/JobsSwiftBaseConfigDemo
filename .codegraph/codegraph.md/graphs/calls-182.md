...
flowchart LR
  ...
  S2 -->|calls| T2
  S3["method:_ASDisplayLayerTests::testSetTransform<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayLayerTests.mm:621"]
  ...
  S4 -->|calls| T4
  S5["function:modifyMethodByAddingPrologueBlockAndReturnCleanupBlock<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:30"]
  T5["function:class_replaceMethodWithBlock<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:23"]
  S5 -->|calls| T5
  ...
  T6["method:ASDisplayNodeAppearanceTests::setUp<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:74"]
  S6 -->|calls| T6
  ...
  S10 -->|calls| T10
  S11["method:ASDisplayNodeAppearanceTests::setUp<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:74"]
  T11["function:modifyMethodByAddingPrologueBlockAndReturnCleanupBlock<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:30"]
  S11 -->|calls| T11
  S12["method:ASDisplayNodeAppearanceTests::tearDown<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:94"]
  T12["method:ASDisplayNodeAppearanceTests::tearDown<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:94"]
  S12 -->|calls| T12
  S13["method:ASDisplayNodeAppearanceTests::testAppearanceMethodsNoLayer<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:228"]
  ...
  S13 -->|calls| T13
  S14["method:ASDisplayNodeAppearanceTests::testAppearanceMethodsNoView<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:233"]
  ...
  S14 -->|calls| T14
  S15["method:ASDisplayNodeAppearanceTests::testAppearanceMethodsLayer<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:238"]
  ...
  S15 -->|calls| T15
  S16["method:ASDisplayNodeAppearanceTests::testAppearanceMethodsView<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:243"]
  T16["method:ASDisplayNodeAppearanceTests::checkManualAppearanceViewLoaded:layerBacked:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:154"]
  S16 -->|calls| T16
  ...
  T17["function:ASDisplayNodeDisableHierarchyNotifications<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASDisplayNodeExtras.mm:329"]
  S17 -->|calls| T17
  ...
  T18["function:ASDisplayNodeEnableHierarchyNotifications<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASDisplayNodeExtras.mm:334"]
  S18 -->|calls| T18
  ...
  T19["function:ASDisplayNodeDisableHierarchyNotifications<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASDisplayNodeExtras.mm:329"]
  S19 -->|calls| T19
  S20["method:ASDisplayNodeAppearanceTests::checkMoveAcrossHierarchyLayerBacked:useManualCalls:useNodeAPI:<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:294"]
  T20["function:ASDisplayNodeEnableHierarchyNotifications<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Source/ASDisplayNodeExtras.mm:334"]
  S20 -->|calls| T20
  S21["method:ASDisplayNodeAppearanceTests::testMoveAcrossHierarchyLayer<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:385"]
  ...
  S21 -->|calls| T21
  S22["method:ASDisplayNodeAppearanceTests::testMoveAcrossHierarchyView<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:390"]
  ...
  S22 -->|calls| T22
  S23["method:ASDisplayNodeAppearanceTests::testMoveAcrossHierarchyManualLayer<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:395"]
  ...
  S23 -->|calls| T23
  S24["method:ASDisplayNodeAppearanceTests::testMoveAcrossHierarchyManualView<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:400"]
  ...
  S24 -->|calls| T24
  S25["method:ASDisplayNodeAppearanceTests::testDisableWithNodeAPILayer<br/>JobsByPods/ManualBySwiftPods@Pods/Texture/Tests/ASDisplayNodeAppearanceTests.mm:405"]
