...
extension Human: ObjectBox.EntityInspectable {
    ...
    fileprivate static func buildEntity(modelBuilder: ObjectBox.ModelBuilder) throws {
        let entityBuilder = try modelBuilder.entityBuilder(for: Human.self, id: 1, uid: 2402126924205133312)
        try entityBuilder.addProperty(name: "id", type: PropertyType.long, flags: [.id], id: 1, uid: 7900468322200341504)
        try entityBuilder.addProperty(name: "name", type: PropertyType.string, id: 2, uid: 6744275704308407808)
        try entityBuilder.addProperty(name: "age", type: PropertyType.int, id: 3, uid: 1287948836976136960)

        try entityBuilder.lastProperty(id: 3, uid: 1287948836976136960)
    }
}
...
fileprivate func cModel() throws -> OpaquePointer {
    ...
    modelBuilder.lastEntity(id: 1, uid: 2402126924205133312)
