Pod::Spec.new do |s|
  s.name         = 'JobsCountdownButton'          # Pod 名
  s.version      = '0.0.1'
  ...
  s.homepage     = 'https://github.com/JobsKits/JobsCountdownButton'
  ...
  # 你的源码从 Git 仓库下载
  s.source       = { :git => 'https://github.com/JobsKits/JobsCountdownButton.git',
                     :tag => s.version.to_s }
